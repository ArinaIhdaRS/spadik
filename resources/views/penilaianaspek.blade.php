...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="alert bg-primary" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em> Pilih RPPH untuk membuat Penilaian Aspek. <a href="#" class="pull-right" data-dismiss="alert"><em class="fa fa-lg fa-close"></em></a></div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach ($rppharian as $key => $rpph)
                                <tr>
                                    ...
                                    <td class="column6">
                                        <a href="{{route('penilaiankegiatanaspek', $rpph->id)}}" type="button" class="btn btn-sm btn-primary"><em class="fa fa-plus"></em> Nilai</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
