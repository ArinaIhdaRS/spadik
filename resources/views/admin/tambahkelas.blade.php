        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form role="form" method="POST" action="{{route('insertdatakelas')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Nama Kelas</label>
                                <input class="form-control" type="text" placeholder="" name="namakelas" value="" required>
                            </div>

                            <div class="form-group">
                                <label>Usia Siswa</label>
                                <input class="form-control" placeholder="" name="usiasiswa" value="" required>
                            </div>
